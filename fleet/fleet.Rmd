...
for (i in (1:nrow(fleet_1))) {
  ...
  } else if (fleet_i$fao_area %in% c("27.4.a", "27.4.b", "27.4.c")) {
    #TBB
    fleet_i <-
      mutate(
        fleet_i,
...
test <-
  distinct(filter(fleet_2, fao_area %in% c("27.3.a.20", "27.3.a.21")),
           ...
           mixfish_fleet)
test_2 <-
  distinct(filter(fleet_2, fao_area %in% c("27.4.a", "27.4.b", "27.4.c")),
           metier_level6_ret,
           mixfish_fleet) 
